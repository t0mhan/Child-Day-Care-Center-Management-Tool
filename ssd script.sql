...
6.   create activity,material table?
    ...
    primary key pk_activity2material(idmaterial,idactivity)
   )ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8;  
...
8. create child_vs_careprovider
    ...
    idchild INT UNSIGNED NOT NULL ,
    idcare_provider INT UNSIGNED NOT NULL ,
    primary key pk_child2provider(idchild,idcare_provider)
   )ENGINE = InnoDB
    DEFAULT CHARACTER SET = utf8
     COLLATE = utf8_general_ci;	
